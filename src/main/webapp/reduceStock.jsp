...
<head>
    <meta charset="UTF-8">
    <title>Reduce Stock | Inventory Control System</title>
...
<div class="card">
    <div class="card-header">
        ...
        <div>
            <h1>Reduce Stock</h1>
            <p>Log inventory outbound shipments, sales, or damage</p>
        </div>
    </div>
    ...
    <form action="ReduceStockServlet" method="post">
        <div class="card-body">
            ...
            <div class="form-group">
                <label for="quantity"><i class="fa-solid fa-arrow-down-short-wide"></i> Quantity to Reduce</label>
            ...
            <div class="form-group">
                ...
                <input type="text" id="referenceNote" name="referenceNote" class="form-control"
                       placeholder="e.g. Dispatched to Dept, Sales order #108">
            </div>

            <button type="submit" class="btn-submit">
                <i class="fa-solid fa-minus-circle"></i> Confirm & Reduce Stock
            </button>
        </div>
